...
<div style="margin-bottom: 0px;">
    <p> Constraints are essential to any well designed UI. With the multplicities of screen sizes ranging from iPads to iPhones, positioning objects on screen is not as simple as drag and drop. In other words, a well designed UI on an iPhone X has no guarantee of being well designed on a iPhone 6. What may be perfectly positioned object on an iPhone X, may be cutoff object on an iPhone 6. </p>
</div>
