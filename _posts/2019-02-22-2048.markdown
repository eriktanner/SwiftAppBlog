...
<div style="">
    <p> Views are visual building blocks of an app's user interface. They can be draw and organize the content of a user's screen, making them essential for any and every developer. They can also animate and respond to touch events, some of which will be described here. </p>
</div>
<br>
