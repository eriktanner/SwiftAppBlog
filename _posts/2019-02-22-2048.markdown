...
<div class="side-by-side" style="margin-top: 0px; margin-bottom: 0px;">
    ...
    <div class="toright" style="padding-top: 12px;">
        <p> To control the board, I decided to create a custom type, ArrowButton, which derives from UIButton, a type which registers touch events. ArrowButton is a UIButton with an UIImageView centered, and functions which orient the arrow and handle the direction the board is collasped on touch events.</p>
    </div>
</div>

<div style="max-height: 325px !important; overflow-y: auto !important; margin-top: 4px; ">
{% highlight swift %}
