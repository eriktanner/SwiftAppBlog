...
<div class="side-by-side">
    ...
    <div class="toright">
        <p> To fill out the grid, I decided to create a custom type, GridButton, which derives from fundamental building block of swift's user interface, UIView. All that GridButton is is a UIView with a Label centered, and functions that which calculates it's backend value and update its display when theboard is collasped.</p>
    </div>
</div>
