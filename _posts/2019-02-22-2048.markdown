...
<div class="side-by-side">
    ...
    <div class="toright">
        <p> To fill out the grid, I decided to create a custom type, GridButton, which derives from UIView, a type which can hold transform information and has properties such as background color. GridButton is a UIView with a Label centered, and functions that which calculates it's backend value and update its display when the board is collasped.</p>
    </div>
</div>
