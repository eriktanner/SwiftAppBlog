...
<div class="side-by-side" style="margin-top: 20px; margin-bottom: 0px;">
    <div class="toleft" style="text-align:center">
        <img class="image" src="https://eriktanner.github.io/SwiftAppBlog/assets/images/2048/IBInspectableRotation.png" alt="Alt Text">
    </div>

    <div class="toright" style="max-height: 200px !important; overflow-y: auto !important;">
{% highlight swift %}
extension UIView {
